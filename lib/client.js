...
(0, _lodash.assign)(Client.prototype, {
  ...
  query: function query(connection, obj) {
    ...
    return this._query(connection, obj).catch(function (err) {
      ...
      _this2.emit('query-error', err, (0, _lodash.assign)({ __knexUid: connection.__knexUid }, obj));
      throw err;
    });
  },
  ...
  initializePool: function initializePool(config) {
    ...
    this.pool = new _genericPool.Pool((0, _lodash.assign)(this.poolDefaults(config.pool || {}), config.pool));
  },
