...
(0, _lodash.assign)(Runner.prototype, {
  ...
  query: _bluebird2.default.method(function (obj) {
    ...
    if (this.builder._single && this.builder._single.user && (this.builder._single.user.id || this.builder._single.user.accountId)) {
      var prefix = '';
      ...
      overridden_obj = (0, _assign2.default)({}, obj, {
        sql: prefix + ' ' + this.builder.toString() + ';',
        bindings: []
      });
    }

    var queryPromise = this.client.query(this.connection, overridden_obj);
